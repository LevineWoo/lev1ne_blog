...
> 呢篇只講正常申請同付款流程。Bybit 同 OpenAI 嘅地區、身份認證同付款要求都應該按真實資料處理，唔建議用虛假地址或者資料去繞過限制。
...
即使普通 Bybit Account 已經做過 KYC，Card 申請仍然有機會要求再確認資料。
...
> 呢條係 Referral Link，我有機會收到平台提供嘅 Referral Reward。用唔用唔影響下面流程。
...
如果已經唔再續，我會直接去原本開 Subscription 嘅平台取消，而唔係靠「張卡冇錢」去阻止扣款。
